...
const ARCHITECTURE_DOC = "blackbox-architecture.md";
...
export function AboutSection() {
  ...
  const [name, setName] = useState("WWX");
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <dl className="grid grid-cols-[110px_1fr] gap-y-2.5 text-[12px]">
        ...
        <dd className="font-mono text-[11.5px]">com.boris.wwx</dd>

        <dt className="text-muted-foreground">License</dt>
        <dd>Apache 2.0 base; private WWX adaptation</dd>

        <dt className="text-muted-foreground">Base project</dt>
        <dd>
          <button
            type="button"
        ...
        <dd className="font-mono text-[11.5px]">{ARCHITECTURE_DOC}</dd>
      </dl>
      ...
      <div className="flex flex-col gap-1.5">
        <div className="flex gap-2">
          ...
          <Button
            variant="ghost"
            size="sm"
            onClick={() => void openUrl("https://terax.app")}
          >
        ...
        <p className="text-[11px] leading-relaxed text-muted-foreground">
          Auto-update endpoints are intentionally not configured for this MVP
          shell. WW-2 engine updates should ship through the private backend.
        </p>
      </div>
    </div>
  );
