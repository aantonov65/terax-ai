...
const batches: BatchSummary[] = [
  {
    ...
    strategyPath: "wwx://account/acct_demo/artifacts/HAIR_LFS_IMAGE_001/strategy.json",
    manifestPath: "wwx://account/acct_demo/artifacts/HAIR_LFS_IMAGE_001/lfs-v41-manifest.json",
    reportPath: "wwx://account/acct_demo/artifacts/HAIR_LFS_IMAGE_001/lfs-v41-report.json",
    alerts: [],
    runs: [
      {
    ...
    artifacts: [
      ...
      },
      {
        id: "acct-hair-report",
        batchId: "HAIR_LFS_IMAGE_001",
        label: "image-report.json",
        path: "wwx://account/acct_demo/artifacts/HAIR_LFS_IMAGE_001/image-report.json",
        kind: "report",
        source: "account",
        content: JSON.stringify(
          {
            ...
            status: "complete",
            engine: "account-fixture",
            images: [{ id: "podcast_thumb_01", status: "complete" }],
          },
          null,
          2,
        ),
  ...
  },
  {
    ...
    strategyPath: "wwx://account/acct_demo/artifacts/HAIR_REPAIR_002/strategy.json",
    manifestPath: "wwx://account/acct_demo/artifacts/HAIR_REPAIR_002/lfs-v41-manifest.json",
    reportPath: "wwx://account/acct_demo/artifacts/HAIR_REPAIR_002/lfs-v41-report.json",
    ...
    artifacts: [
      ...
      {
        id: "acct-repair-report",
        batchId: "HAIR_REPAIR_002",
        label: "lfs-v41-report.json",
        path: "wwx://account/acct_demo/artifacts/HAIR_REPAIR_002/lfs-v41-report.json",
        kind: "report",
        source: "account",
        content: JSON.stringify(
          {
            ...
            status: "review",
            blocked_issue: "CTA tone needs repair",
            recovery_policy: "Use V4.1 objective/semantic repair flow.",
          },
          null,
          2,
        ),
  ...
  },
  {
    ...
    artifacts: [
      ...
      {
        id: "acct-sleep-report",
        batchId: "SLEEP_IMAGES_001",
        label: "image-report.json",
        path: "wwx://account/acct_demo/artifacts/SLEEP_IMAGES_001/image-report.json",
        kind: "report",
        source: "account",
        content: JSON.stringify(
          {
            ...
            status: "complete",
            engine: "account-fixture",
            images: [{ id: "bedside_patch_01", status: "complete" }],
          },
          null,
          2,
        ),
