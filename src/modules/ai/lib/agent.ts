...
const TOOL_LABELS: Record<string, (input: Record<string, unknown>) => string> = {
  ...
  create_ads: () => "Creating ads",
  start_research_run: () => "Running product research",
  list_research_runs: () => "Listing research runs",
  get_batch_status: (i) => `Inspecting ${String(i.batch_id ?? "bound batch")}`,
  list_final_ads: () => "Listing final ads",
  get_final_ad: (i) => `Reading ${shortPath(i.artifact_id ?? i.task_id)}`,
  get_asset_inputs: () => "Reading asset inputs",
  get_batch_metrics: () => "Reading batch metrics",
  analyze_ads: () => "Analyzing ads",
